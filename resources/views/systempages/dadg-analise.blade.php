    ...
    <div class="row">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="last">
                                    <a href="#" class="btn btn-success btn-xs"><i class="fa fa-check"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> Aprovar </font></font></a>
                                </td>
                                <td class="last">
                                    <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-times"></i><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"> Reprovar </font></font></a>
                                </td>
            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox" >
                        <li>
                            <a class="collapse-link"><small class="count_bottom blue"> Ocultar/Ver Comentário</small> <i class="fa fa-chevron-up"></i></a>
                        </li>
                    </ul>
                    <div class="clearfix"></div>
                </div>
                <div class="content">
                    <h3 class="x_content"><small>Comentario da Tabela Actividade: Comentário sobre a tabela de actividade Comentario sobre a tabela de actividade Comentario sobre a tabela de actividade</small></h3>
                    <div class="clearfix"></div>
                    <div class="table-responsive">
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-">Comentario da Tabela Actividade: </label>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="content">
                    <h3 class="x_content"><small>Comentario da Tabela de Custo: Comentário sobre a tabela de Custo Comentario sobre a tabela de Custo Comentario sobre a tabela de Custo</small></h3>
                    <div class="clearfix"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered jambo_table bulk_action">
                            <thead>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="content">
                    <h3 class="x_content"><small>Comentario da Tabela de Difusão: Comentário sobre a tabela de Difusão Comentario sobre a tabela de Difusão Comentario sobre a tabela de Difusão</small></h3>
                    <div class="clearfix"></div>
                    <div class="table-responsive">
                        <table class="table table-bordered jambo_table bulk_action">
                            <thead>
